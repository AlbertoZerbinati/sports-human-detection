 ...
 * ignoreTeamColors is a flag that if it is true admit to ignore the last two parameters for team specification 
 * the map container and the int value are used to store key-value pairs of colors (represented as cv::Vec3b) and their associated counts
 * teamColors is used to compare Vec3b color vectors
 * */
